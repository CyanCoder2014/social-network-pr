                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example1"
                                ...
                                @foreach( $contents as $content )
                                    ...
                                    <tr class="odd gradeX">
                                        <td style="text-align: center"><a href="<?= Url('/admin/project/edit/'.$content->id ); ?>"><i class="icon-gear"></i> </a>  </td>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="<?= Url('/admin/project/edit/'.$content->id ); ?>"><i class="icon-gear"></i></a>
                                            @endpermission
                                        </td>
                                        <td style="text-align: center">
                                            @permission('project-delete')
                                            <a onclick="return confirm('آیا از حذف این پروژه مطمئن هستید؟');"  href="<?= Url('/admin/project/destroy/'.$content->id ); ?>"><i class="icon-remove"></i> </a>
                                            @endpermission
                                        </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example2"
                            ...
                            @foreach( $contents as $content_ )
                                ...
                                <tr class="odd gradeX">
                                    <td style="text-align: center"><a href="<?= Url('/admin/project/edit/'.$content_->id ); ?>"><i class="icon-gear"></i> </a>  </td>
                                    ...
                                    <td>{!! Jdate::to_jalali($content_->created) !!}</td>
                                    <td style="text-align: center"><a href="<?= Url('/admin/project/edit/'.$content_->id )?> "><i class="icon-gear"></i> </a>  </td>
                                    <td style="text-align: center"><a onclick="return confirm('آیا از حذف این پروژه مطمئن هستید؟');"  href="<?= Url('/admin/project/destroy/'.$content_->id ); ?>"><i class="icon-remove"></i> </a> </td>
...
{{$contents->links()}}
                ...
                <div class=" footer">
                    ...
                    <a type="button" class="btn btn-primary btn-circle btn-lg" href="<?= Url('admin/project/create'); ?>"><i class="icon-plus"></i></a>
                    @endpermission
                </div>
            </div>
        </div>
