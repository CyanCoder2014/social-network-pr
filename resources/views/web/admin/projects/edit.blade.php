...
@section('admin_content')
    ...
    <div id="content">
        ...
        <div class="inner" style="min-height: 700px;">
                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                      action="<?= Url('admin/project/update/' . $record->id); ?>">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="input-group">
                               <span class="input-group-btn">
                                ...
                                <input id="video" class="form-control" type="text" name="video" value="{{$record->video}}">
                            </div>
                            <video controls id="videoID">
                                <source id="videoholder" src="{{$record->video}}" type="video/mp4">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="picp" class="table-striped " style="width:100%">
                                ...
                                @if($record->pimages)
                                    @foreach($record->pimages as $key => $image)
                                        <tr>
                                            <td>
                    ...
                    <a  class="btn btn-danger" style="margin-right: 10px" onclick="return confirm('آیا از حذف این پروژه مطمئن هستید؟');"  href="<?= Url('/admin/project/destroy/'.$record->id ); ?>"><i class="icon-remove"></i> </a>
    ...
    <script>
        var fileCount = {{count($record->pimages)}};
        var max_file=10;
