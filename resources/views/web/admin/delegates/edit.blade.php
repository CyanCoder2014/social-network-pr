        ...
        <div class="inner" style="min-height: 700px;">
            <div class="row">
                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                      action="{{ route('del.update',['id' => $record->id]) }}">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <input type="hidden"  name="lng" id="lng" value="{{$record->lng}}">
                    <input type="hidden"  name="lat" id="lat" value="{{$record->lat}}">
                    <div class="row">
                        ...
                        <div>
                            ...
                            <!-- or set via JS -->
                            <input id="phone" type="text" name="tel" value="{{$record->tel}}" />
                        </div>
                    </div>
                                    ...
                                    <div class="row col-lg-12" style="z-index: 99">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="name_fa" value="{{$record->name['fa']}}">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="tab-pane fade in active" id="english">
                                        <div class="row col-lg-12" style="z-index: 99">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label>name</label>
                                                    <input class="form-control" name="name" value="{{$record->name['en']}}">
                                                </div>
                                                <div class="form-group">
                    ...
                    <a  class="btn btn-warning" style="margin-right: 10px" onclick="return confirm('به انصراف  تمایل دارید؟');"  href="<?= Url('/admin/project' ); ?>"><i class="icon-remove"></i> </a>
