                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            <label for="">سردسته</label>
                            <!-- <input type="text" id="searchmap"> -->
                            <select name="parent_id">
                                <option value="0">ندارد</option>
                                @foreach($menus as $menu)
                                    <option value="{{$menu->id}}"
                                            @if($menu->id == old('parent_id'))
                                            selected
                                            @endif
                                    >{{$menu->name['fa']}}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                           ...
                           <select id="active" name="active">
                                   ...
                                   <option value="1" @if(old('active')) selected @endif>فعال</option>
                        ...
                        <div class="disappear">
                            <div class="form-group col-md-6 col-xs-12">
                                ...
                                <input  type="text" name="paginate" value="{{old('paginate')}}" />
                            </div>
                            <div class="form-group col-md-6 col-xs-12">
                            ...
                            <select id="projectcategory" name="projectcategory">
                                @foreach($prcategories as $category)
                                    <option value="{{$category->id}}"
                                            @if((old('type') == 4 ||old('type') == 5) && old('link.fa') == $category->id )
                                            selected @endif>
                                        {{$category->title_fa}}
                                    </option>
                                @endforeach
                                    ...
                                    <div class="row col-lg-12" style="z-index: 99">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label for="">نام</label>
                                                <input id="fa_name" class="name" type="text" name="name[fa]" value="{{old('name.fa')}}" />
                                            </div>
                                            <div class="form-group link">

                                            <label>لینک</label>
                                                <input id="fa_link"  type="text" name="link[fa]" value="{{old('link.fa')}}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row col-lg-12" style="z-index: 99">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="en_name" class="name" type="text" name="name[en]" value="{{old('name.en')}}" />
                                                </div>
                                                <div class="form-group link">

                                                    <label>link</label>
                                                    <input id="en_link"  type="text" name="link[en]" value="{{old('link.en')}}" />
                                                </div>
                                            </div>
                                        </div>
