    ...
    <div id="content">
        ...
        <div class="inner" style="min-height: 700px;">
                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                      action="<?= Url('admin/technology/update/' . $record->id); ?>">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="file" name="images_u" value="images_u" style="position: absolute; margin-top: 40px"
                                   accept="images/*"/>
                            <div class="col-lg-1 col-md-3 col-sm-12 col-xs-12"></div>
                            <img src="{{'../../../images/'.$record->images}}"
                                 alt="" style="width: 100px ;border: 1px solid #5e5e5e">
                    ...
                    <a  class="btn btn-danger" style="margin-right: 10px" onclick="return confirm('آیا از حذف این تکنولوژی مطمئن هستید؟');"  href="<?= Url('/admin/technology/destroy/'.$record->id ); ?>"><i class="icon-remove"></i> </a>
