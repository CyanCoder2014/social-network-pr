                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-62 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="1" name="text"></textarea>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="valency">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            ...
                            <select class="form-control" name="publish" onselect="{{1}}">
                                <option value="0" @if(1 == 0 )
                                selected
                                        @endif >خیر
                                </option>
                                <option value="1" @if(1 == 1 )
                                selected
                                        @endif >بلی
                                </option>
...
<!--
                            <div class="form-group ">
                                <label class="control-label col-lg-12">انتخاب تصویر</label>
                                <div class="col-lg-8"><input type="file" name="images" value="images"
                                                             accept="images/*"/></div>
                            </div>
-->
                        </div>
                    ...
                    <textarea name="content_c" id="editor1" rows="10" cols="80">
