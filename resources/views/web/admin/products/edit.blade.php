...
@section('admin_content')
        ...
        <div class="inner" style="min-height: 700px;">
            <div class="row">
                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                      action="{{ route('product.update',['id' => $content->id]) }}">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="catid" onselect="">
                                    @foreach($categories as $category)
                                        <option @if($category->id == $content->cat) selected @endif value="{{ $category->id }}">{{ $category->title  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <table id="picp" class="table-striped " style="width:100%">
                                ...
                                @if($content->images)
                                    @foreach($content->images as $key => $image)
                                        <tr>
                                            <td>
                                                <a data-input="Image{{$key}}" data-preview="holder{{$key}}"  class="lfm btn btn-primary">
                                                    <i class="fa fa-picture-o"></i>انتخاب</a>
                                            <td> <input id="Image{{$key}}" class="form-control" type="text" name="Pimages[]" value="{{$image}}"> </td>
                                            <td><img id="holder{{$key}}" src="{{$image}}" style="margin-top:15px;max-height:100px;"></td>
                                    ...
                                    <div class="tab-pane fade in active" id="english">
                                        ...
                                        <div class="row" style="z-index: 99">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="title[fa]" value="{{$content->title['fa']}}">
                                                </div>
                                        ...
                                        <div class="col-xs-12">
                                            <table>
                                                ...
                                                @if(isset($content->meta['fa']))
                                                @foreach($content->meta['fa'] as $key => $item)
                                                    <tr>
                                                        <td> <input class="form-control" type="text" name="ftitle[fa][]" value="{{$key}}"> </td>
                                                        <td> <input class="form-control" type="text" name="fdesc[fa][]" value="{{$item}}"> </td>
                                    ...
                                    <div class="tab-pane fade" id="persian" style="direction: ltr; text-align: left">
                                        ...
                                        <div class="row" style="z-index: 99">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label> Title</label>
                                                    <input class="form-control" name="title[en]" value="{{$content->title['en']}}">
                                                </div>
                                        ...
                                        <div class="col-xs-12">
                                            <table>
                                                ...
                                                @if(isset($content->meta['en']))
                                                @foreach($content->meta['en'] as $key => $item)
                                                    <tr>
                                                        <td> <input class="form-control" type="text" name="ftitle[en][]" value="{{$key}}"> </td>
                                                        <td> <input class="form-control" type="text" name="fdesc[en][]" value="{{$item}}"> </td>
                                                        <td> <a href="javascript:void(0);" class="remove_button" title="Remove field"><span class="glyphicon glyphicon-remove"></span></a></td>
                                                    </tr>
                                                @endforeach
                                                @endif
    ...
    <script>
        var fileCount = {{count($content->images)}};
        var max_file=10;
