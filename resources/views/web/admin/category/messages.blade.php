            ...
            <div class="row">
                ...
                <section id="lts_sec " class="right" style="margin: 125px auto">
                    ...
                    <div class="container ">
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        @foreach($tickets as $ticket)
                                            <tr class="odd gradeX">
                                                ...
                                                <th>
                                                    &nbsp; {{\Illuminate\Support\Str::words($ticket->title, $words = 6, $end = '...') }}</th>
                                                ...
                                                <th> {!!  to_jalali($ticket->datetime) !!}</th>
                                                <th> {!!  to_jalali($ticket->last_loin) !!}</th>
                                                <th style="text-align: center"><a
                                                            class="btn btn-warning btn-line btn-sm"
                                                            href="<?= Url('admin/ticket/ticket/' . $ticket->id); ?>"><i
                                                                class="fa fa-ticket"></i> </a></th>
                                                <th style="text-align: center"><a onclick="return confirm('آیا از حذف این تیکت مطمئن هستید؟');"
                                                                                  href="#"><i
                        ...
                        <a class="btn btn-danger btn-line " href="<?= Url('admin/ticket/create'); ?>"><i
                                    class="fa fa-ticket"></i> &nbsp;&nbsp; تیکت جدید</a>
